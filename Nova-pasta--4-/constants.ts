...
export const API_KEY = "escritorioflabarbosa@gmail.com_fjli7gYFkXxrbgAivz2RH45OyXgkXj9VyixMpNtmsaqOKBgbGc3SxfGSnmbwfeho";

// PDF Configuration - Adjusted for A4 with larger bottom margin for Footer
export const PDF_CONFIG = {
    paperSize: 'A4',
    // Top: 25mm, Right: 15mm, Bottom: 30mm (Reserved for Footer), Left: 15mm
    margins: '25mm 15mm 30mm 15mm', 
...
const pdfStyles = `
  <style>
    ...
    * {
    ...
    @page {
      size: A4;
      margin: 0; /* We use the API margins to define the content box */
    }
    ...
    body { 
      ...
      margin: 0;
      /* CRITICAL: Padding bottom ensures text flows to next page BEFORE hitting the fixed footer */
      padding-bottom: 50px; 
      width: 100%;
    }
    ...
    p { 
      ...
      orphans: 3; 
      widows: 3;
      page-break-inside: avoid; /* Prevent splitting paragraphs weirdly */
    }
    ...
    /* 5. Footer Styling - Fixed Position with Clearance */
    .footer { 
      font-size: 9pt; 
      color: #333; 
      position: fixed; 
      ...
      left: 0; 
      right: 0; 
      height: 50px; /* Matches body padding-bottom approx */
...
const footerHtml = `
  <div class="footer">
    <table style="width: 100%; border: none;">
      <tr>
        <td style="text-align: left; width: 65%; vertical-align: top; border: none; padding: 0;">
